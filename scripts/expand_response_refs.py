#!/usr/bin/env python3
"""Expand local $ref values in schemas/response into standalone JSON files.

Input : schemas/response/**/*.json
Output: schemas/response_expanded/**/*.json
"""
...
SRC_DIR = ROOT / "schemas" / "response"
OUT_DIR = ROOT / "schemas" / "response_expanded"
